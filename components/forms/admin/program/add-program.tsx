            ...
            <Field data-invalid={fieldState.invalid} className="mt-4">
              <div className="flex flex-col">
                ...
                <textarea
                  ...
                  className="border-[0.75px] border-[#EAECF0] bg-[#F2F4F7] rounded-[5px] w-full text-[12px] font-medium text-[#344054] placeholder:text-[#98A2B3] py-4 min-h-[120px] outline-none px-3 resize-none"
                />
              </div>
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={fieldState.invalid} className="mt-4">
              ...
              <Input
                ...
                placeholder="0.00"
                className="border-[#DBDBDB]  rounded-[10px] border placeholder:text-[#888888] text-[1.125rem] font-medium h-[55px] shadow-none"
              />
              {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
            </Field>
          )}
