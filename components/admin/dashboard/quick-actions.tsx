    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-4 overflow-x-auto scrollbar-hide ">
        {actions.map((action, i) => (
          <Link key={i} href={action.url} className="flex flex-col items-center justify-center gap-4 bg-dash-secondary-bg rounded-[10px] p-6 lg:min-w-[200px] min-w-[250px] flex-1 lg:flex-none  transition-transform hover:-translate-y-1">
            {action.icon}
